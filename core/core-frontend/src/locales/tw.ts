export default {
  ...
  // 使用者管理頁面相關翻譯
  'user_management.title': '使用者管理',
  'user_management.create_user': '建立使用者',
  'user_management.edit_user': '編輯使用者',
  'user_management.search_placeholder': '搜尋使用者名稱、帳號或電子郵件',
  'user_management.account': '帳號',
  'user_management.name': '姓名',
  'user_management.email': '電子郵件',
  'user_management.phone': '電話',
  'user_management.status': '狀態',
  'user_management.roles': '角色',
  'user_management.enabled': '已啟用',
  'user_management.disabled': '已停用',
  'user_management.enable': '啟用',
  'user_management.disable': '停用',
  'user_management.password': '密碼',
  'user_management.account_required': '請輸入帳號',
  'user_management.name_required': '請輸入姓名',
  'user_management.email_format': '請輸入正確的電子郵件格式',
  'user_management.password_required': '請輸入密碼',
  'user_management.password_min_length': '密碼至少6位',
  'user_management.fetch_error': '取得使用者清單失敗',
  'user_management.create_success': '使用者建立成功',
  'user_management.edit_success': '使用者編輯成功',
  'user_management.submit_error': '提交失敗',
  'user_management.status_updated': '狀態更新成功',
  'user_management.status_update_error': '狀態更新失敗',
  'user_management.delete_confirm': '確定要刪除使用者 {name} 嗎？',
  'user_management.delete_success': '使用者刪除成功',
  'user_management.delete_error': '使用者刪除失敗',
  'user_management.edit': '編輯',
  'user_management.delete': '刪除',
  'user_management.load_failed': '載入使用者清單失敗',
  'user_management.load_roles_failed': '載入角色清單失敗',
  'user_management.submit_failed': '提交失敗',
  'user_management.name_placeholder': '請輸入姓名',
  'user_management.account_placeholder': '請輸入帳號',
  'user_management.email_placeholder': '請輸入電子郵件',
  'user_management.phone_placeholder': '請輸入電話',
  'user_management.password_placeholder': '請輸入密碼',
  'user_management.roles_placeholder': '請選擇角色',
  'user_management.roles_required': '請選擇角色',
  'user_management.email_invalid': '請輸入正確的電子郵件格式',
  'user_management.cancel': '取消',
  'user_management.password_edit_placeholder': '留空則不修改密碼',
  'user_management.password_edit_tip': '留空則不修改密碼，輸入新密碼將替換原密碼'
}
