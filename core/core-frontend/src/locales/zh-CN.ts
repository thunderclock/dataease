export default {
  ...
  visualization: {
    ...
    current_page: '当前页',
    service_name: '服务名称',
    service_name_placeholder: '请输入服务名称',
    service_description: '服务描述',
    service_description_placeholder: '请输入服务描述（可选）',
    save_service: '保存服务',
    load_saved: '加载已保存',
    saved_services: '已保存的服务',
    create_time: '创建时间',
    operation: '操作',
    load: '加载',
    close: '关闭',
    ...
    format_failed: '格式化失败',
    copy_success: '复制成功',
    service_name_required: '请输入服务名称',
    save_success: '保存成功',
    save_failed: '保存失败',
    load_success: '加载成功',
    delete_success: '删除成功',
    chart_info_not_found: '未找到图表信息',
    dataset_id_required: '请输入数据集ID',
    select_dimension: '请选择维度',
    select_quota: '请选择度量',
    add_filter: '添加过滤条件',
    query_chart_data: '查询图表数据（ID方式）',
    query_data: '查询数据（字段名方式）',
    query_data_tips: '此方式将从图表配置中自动解析维度和指标，使用字段名进行查询',
    access_key_config: 'AccessKey 配置',
    access_key: 'AccessKey',
    access_key_placeholder: '请输入 AccessKey（如：de_abc123...）',
    access_secret: 'AccessSecret',
    access_secret_placeholder: '请输入 AccessSecret（用于签名验证）',
    access_key_tip:
      '配置 AccessKey 后，所有测试请求将使用签名验证。AccessSecret 请妥善保管，不要泄露。',
    auto_from_chart: '（自动从图表配置获取）',
    dataset_params: '数据集参数',
    add_dataset_param: '添加数据集参数',
    dataset_param: '数据集参数',
    variable_name: '变量名',
    variable_name_placeholder: '请输入 SQL 变量名（如：start_date）',
    dataset_table_id: '数据集表ID',
    dataset_table_id_placeholder: '请输入数据集表ID',
    dataset_group_id: '数据集组ID',
    dataset_group_id_placeholder: '请输入数据集组ID（可选）',
    operator: '操作符',
    operator_placeholder: '选择操作符（默认：eq）',
    operator_tip: '可选：eq（等于）、in（包含）、between（区间）。留空默认为 eq',
    param_value: '参数值',
    param_value_placeholder: '请输入参数值，多个值用逗号分隔（如：2024-01-01,2024-01-02）',
    param_value_tip: '多个值用逗号分隔，in 操作符可传入多个值，between 操作符传入两个值',
    no_dataset_params: '暂无数据集参数',
    no_dimensions: '暂无维度字段',
    no_measures: '暂无度量字段',
    dimensions_or_measures_required: '至少需要选择一个维度或度量字段',
    sort: '排序',
  ...
  'user_management.create_user': '创建用户',
  'user_management.edit_user': '编辑用户',
  'user_management.search_placeholder': '搜索用户名、账号或邮箱',
  'user_management.account': '账号',
  'user_management.name': '姓名',
  'user_management.email': '邮箱',
  'user_management.phone': '电话',
  'user_management.status': '状态',
  'user_management.roles': '角色',
  'user_management.enabled': '启用',
  'user_management.disabled': '禁用',
  'user_management.enable': '启用',
  'user_management.disable': '禁用',
  'user_management.password': '密码',
  'user_management.account_required': '请输入账号',
  'user_management.name_required': '请输入姓名',
  'user_management.email_format': '请输入正确的邮箱格式',
  'user_management.password_required': '请输入密码',
  'user_management.password_min_length': '密码至少6位',
  'user_management.fetch_error': '获取用户列表失败',
  'user_management.create_success': '用户创建成功',
  'user_management.edit_success': '用户编辑成功',
  'user_management.submit_error': '提交失败',
  'user_management.status_updated': '状态更新成功',
  'user_management.status_update_error': '状态更新失败',
  'user_management.delete_confirm': '确定要删除用户 {name} 吗？',
  'user_management.delete_success': '用户删除成功',
  'user_management.delete_error': '用户删除失败',
  'user_management.edit': '编辑',
  'user_management.delete': '删除',
  'user_management.load_failed': '加载用户列表失败',
  'user_management.load_roles_failed': '加载角色列表失败',
  'user_management.submit_failed': '提交失败',
  'user_management.name_placeholder': '请输入姓名',
  'user_management.account_placeholder': '请输入账号',
  'user_management.email_placeholder': '请输入邮箱',
  'user_management.phone_placeholder': '请输入电话',
  'user_management.password_placeholder': '请输入密码',
  'user_management.roles_placeholder': '请选择角色',
  'user_management.roles_required': '请选择角色',
  'user_management.email_invalid': '请输入正确的邮箱格式',
  'user_management.cancel': '取消',
  'user_management.password_edit_placeholder': '留空则不修改密码',
  'user_management.password_edit_tip': '留空则不修改密码，输入新密码将替换原密码',
  // AccessKey 管理页面相关翻译
  access_key_management: {
    title: 'AccessKey 管理',
    generate_key: '生成 AccessKey',
    name: '名称',
    name_placeholder: '请输入 AccessKey 名称',
    name_required: '请输入 AccessKey 名称',
    bound_user: '绑定用户',
    select_user_placeholder: '请选择绑定的用户',
    user_required: '请选择绑定的用户',
    bound_user_tip: 'AccessKey 将使用该用户的权限进行数据访问，支持行级权限控制',
    access_key: 'AccessKey',
    access_secret: 'AccessSecret',
    status: '状态',
    enabled: '已启用',
    ...
    expire_time: '过期时间',
    never_expires: '永不过期',
    custom_expire: '自定义过期时间',
    select_expire_time: '请选择过期时间',
    create_time: '创建时间',
    last_use_time: '最后使用时间',
    key_generated: 'Key 生成成功',
    secret_warning: '请妥善保管 AccessSecret，它只会显示一次，关闭对话框后将无法再次查看！',
    load_failed: '加载 AccessKey 列表失败',
    generate_success: 'AccessKey 生成成功',
    generate_failed: 'AccessKey 生成失败',
    disable_confirm: '确定要禁用 AccessKey "{name}" 吗？',
    disable_success: 'AccessKey 禁用成功',
    disable_failed: 'AccessKey 禁用失败',
    delete_confirm: '确定要删除 AccessKey "{name}" 吗？',
    delete_success: 'AccessKey 删除成功',
    delete_failed: 'AccessKey 删除失败',
    copy_success: '复制成功',
    copy_failed: '复制失败'
  }
}
