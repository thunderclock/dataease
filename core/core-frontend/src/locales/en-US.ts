export default {
  ...
  visualization: {
    ...
    service_description_placeholder: 'Please enter service description (optional)',
    ...
    service_name_required: 'Please enter service name',
    save_failed: 'Save Failed',
    load_success: 'Load Success',
    chart_info_not_found: 'Chart info not found',
    dataset_id_required: 'Please enter dataset ID',
    select_quota: 'Please select measure',
    add_filter: 'Add Filter',
    query_chart_data: 'Query Chart Data (ID Mode)',
    query_data: 'Query Data (Field Name Mode)',
    query_data_tips:
      'This mode will automatically parse dimensions and measures from chart configuration, using field names for query',
    access_key_config: 'AccessKey Config',
    access_key: 'AccessKey',
    access_key_placeholder: 'Please enter AccessKey (e.g., de_abc123...)',
    access_secret: 'AccessSecret',
    access_secret_placeholder: 'Please enter AccessSecret (for signature verification)',
    access_key_tip:
      'After configuring AccessKey, all test requests will use signature verification. Please keep AccessSecret safe and do not leak it.',
    auto_from_chart: '(Auto from chart config)',
    dataset_params: 'Dataset Parameters',
    add_dataset_param: 'Add Dataset Parameter',
    dataset_param: 'Dataset Parameter',
    variable_name: 'Variable Name',
    variable_name_placeholder: 'Please enter SQL variable name (e.g., start_date)',
    dataset_table_id: 'Dataset Table ID',
    dataset_table_id_placeholder: 'Please enter dataset table ID',
    dataset_group_id: 'Dataset Group ID',
    dataset_group_id_placeholder: 'Please enter dataset group ID (optional)',
    operator: 'Operator',
    operator_placeholder: 'Select operator (default: eq)',
    operator_tip:
      'Optional: eq (equal), in (contains), between (range). Leave empty for default eq',
    param_value: 'Parameter Value',
    param_value_placeholder:
      'Please enter parameter value, multiple values separated by comma (e.g., 2024-01-01,2024-01-02)',
    param_value_tip:
      'Multiple values separated by comma, in operator can accept multiple values, between operator accepts two values',
    no_dataset_params: 'No dataset parameters',
    no_dimensions: 'No dimension fields',
    no_measures: 'No measure fields',
    dimensions_or_measures_required: 'At least one dimension or measure field is required'
  },
  template_manage: {
  ...
  // User management page related translations
  'user_management.title': 'User Management',
  'user_management.create_user': 'Create User',
  'user_management.edit_user': 'Edit User',
  'user_management.search_placeholder': 'Search username, account or email',
  'user_management.account': 'Account',
  'user_management.name': 'Name',
  'user_management.email': 'Email',
  'user_management.phone': 'Phone',
  'user_management.status': 'Status',
  'user_management.roles': 'Roles',
  'user_management.enabled': 'Enabled',
  'user_management.disabled': 'Disabled',
  'user_management.enable': 'Enable',
  'user_management.disable': 'Disable',
  'user_management.password': 'Password',
  'user_management.account_required': 'Please enter account',
  'user_management.name_required': 'Please enter name',
  'user_management.email_format': 'Please enter correct email format',
  'user_management.password_required': 'Please enter password',
  'user_management.password_min_length': 'Password must be at least 6 characters',
  'user_management.fetch_error': 'Failed to fetch user list',
  'user_management.create_success': 'User created successfully',
  'user_management.edit_success': 'User edited successfully',
  'user_management.submit_error': 'Submit failed',
  'user_management.status_updated': 'Status updated successfully',
  'user_management.status_update_error': 'Status update failed',
  'user_management.delete_confirm': 'Are you sure to delete user {name}?',
  'user_management.delete_success': 'User deleted successfully',
  'user_management.delete_error': 'User deletion failed',
  'user_management.edit': 'Edit',
  'user_management.delete': 'Delete',
  'user_management.load_failed': 'Failed to load user list',
  'user_management.load_roles_failed': 'Failed to load role list',
  'user_management.submit_failed': 'Submit failed',
  'user_management.name_placeholder': 'Please enter name',
  'user_management.account_placeholder': 'Please enter account',
  'user_management.email_placeholder': 'Please enter email',
  'user_management.phone_placeholder': 'Please enter phone',
  'user_management.password_placeholder': 'Please enter password',
  'user_management.roles_placeholder': 'Please select roles',
  'user_management.roles_required': 'Please select roles',
  ...
  access_key_management: {
    ...
    secret_warning:
      'Please keep AccessSecret safe. It will only be displayed once and cannot be viewed again after closing the dialog!',
